...
if(~checkFile(fname_att)) data_att_avail = false; end;
if(~checkFile(fname_att_sp)) data_att_sp_avail = false; end;
if(~checkFile(fname_lp)) data_lp_avail = false; end;
if(~checkFile(fname_lp_sp)) data_lp_sp_avail = false; end;
if(~checkFile(fname_flow)) data_flow_avail = false; end;
if(~checkFile(fname_sens)) data_sensor_avail = false; end;
if(~checkFile(fname_debug_vect)) data_dbg_vect_avail = false; end;
if(~checkFile(fname_dist)) data_distance_avail = false; end;
if(~checkFile(fname_input_rc)) data_input_rc_avail = false; end;
if(~checkFile(fname_power_sys)) data_pwr_sys_avail = false; end;
if(~checkFile(fname_batt_sts)) data_batt_sts_avail = false; end;
if(~checkFile(fname_air_data)) data_air_data_avail = false; end;
if(~checkFile(fname_land_detect)) data_land_detect_avail = false; end;
if(~checkFile(fname_v_status)) data_v_status_avail = false; end;
